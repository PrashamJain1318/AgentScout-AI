      ...
      <div className="resume-section-card">
        <div className="section-header-flex">
          <div>
            ...
            <h3>High-Demand Skill Improvement</h3>
          </div>
        </div>
        <p className="no-data-text">Your profile skills match active market requirements cleanly.</p>
      </div>
    );
  }
  ...
  return (
    <div className="resume-section-card">
      <div className="section-header-flex">
        <div>
          <span className="eyebrow">SKILL INTELLIGENCE</span>
          <h3>Market-Demand Skill Actions ({actions.length})</h3>
        </div>
      </div>
        ...
        {actions.map((act) => (
          <div key={act.id} className="suggestion-item-card flex-between">
            ...
            <button
              ...
              onClick={() => navigate(act.deepLink || "/dashboard/career-copilot")}
            >
